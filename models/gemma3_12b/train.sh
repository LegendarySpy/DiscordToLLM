...
TRAIN_OUTPUT_DIR="$(to_abs "${TRAIN_OUTPUT_DIR:-models/gemma3_12b/output/lora}")"
TRAIN_BASE_MODEL="${TRAIN_BASE_MODEL:-google/gemma-3-12b-it}"

CMD=(
  "$PY_BIN"
  "$REPO_DIR/models/gemma3_12b/train_gemma3_12b.py"
