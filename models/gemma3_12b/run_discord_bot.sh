...
LLAMA_MODEL_PATH="${LLAMA_MODEL_PATH:-$REPO_DIR/models/gemma3_12b/output/gguf/gemma-3-12b-it.Q8_0.gguf}"
...
BOT_SCRIPT="${BOT_SCRIPT:-$REPO_DIR/models/gemma3_12b/discord_gemma3_12b_bot.py}"
