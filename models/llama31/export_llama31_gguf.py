...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser("export lora -> gguf (llama 3.1 + unsloth)")
    p.add_argument("--base_model", type=str, default="meta-llama/Meta-Llama-3.1-8B-Instruct")
    p.add_argument("--lora_dir", type=str, default="models/llama31/output/lora")
    p.add_argument("--out_dir", type=str, default="models/llama31/output/gguf")
