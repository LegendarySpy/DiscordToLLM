...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser("llama 3.1 8b sft (unsloth + trl)")

    p.add_argument("--dataset", type=str, required=True, help="path to dataset.jsonl (ShareGPT-style)")
    p.add_argument("--output_dir", type=str, default="models/llama31/output/lora")

    p.add_argument("--model", type=str, default="meta-llama/Meta-Llama-3.1-8B-Instruct")
    ...
    p.add_argument("--chat_template", type=str, default="auto", help="auto, llama-3, chatml, ...")
...
def main() -> None:
    ...
    # response-only loss masking (llama-3 style headers)
