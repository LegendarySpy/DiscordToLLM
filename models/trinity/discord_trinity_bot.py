...
SYSTEM_PROMPT = _env_str("SYSTEM_PROMPT", "").strip()
...
BASE_MODEL = _env_str("BASE_MODEL", "arcee-ai/Trinity-Nano-Preview")
LORA_DIR = _env_str("LORA_DIR", "models/trinity/output/lora")
USE_4BIT = _env_bool01("USE_4BIT", True)
TRUST_REMOTE_CODE = _env_bool01("TRUST_REMOTE_CODE", True)
