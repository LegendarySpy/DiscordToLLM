...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser("trinity nano sft (unsloth + trl)")

    p.add_argument("--dataset", type=str, required=True, help="path to dataset.jsonl (ShareGPT-style)")
    p.add_argument("--output_dir", type=str, default="models/trinity/output/lora")

    p.add_argument("--model", type=str, default="arcee-ai/Trinity-Nano-Preview")
    ...
    # Trinity Nano is custom code (afmoe); default True to avoid your exact crash.
...
def main() -> None:
    ...
    # stick to chatml so response-only masking is consistent
    ...
    # response-only loss masking (chatml markers)
