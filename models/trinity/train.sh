...
TRAIN_OUTPUT_DIR="$(to_abs "${TRAIN_OUTPUT_DIR:-models/trinity/output/lora}")"
TRAIN_BASE_MODEL="${TRAIN_BASE_MODEL:-arcee-ai/Trinity-Nano-Preview}"

CMD=(
  "$PY_BIN"
  "$REPO_DIR/models/trinity/train_trinity_nano.py"
